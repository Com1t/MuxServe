...
cache_extension = CUDAExtension(
    name="muxserve.memory_manager",
    sources=["csrc/memory_manager.cpp"],
    extra_compile_args={
        "cxx": CXX_FLAGS,
    },
)
...
scheduler_extension = CUDAExtension(
    name="muxserve.batch_scheduler",
    sources=["csrc/batch_scheduler.cpp"],
    extra_compile_args={
        "cxx": CXX_FLAGS,
    },
)
ext_modules.append(scheduler_extension)
...
setuptools.setup(
    name="muxserve",
    version=find_version(get_path("muxserve", "__init__.py")),
    author="MuxServe Team",
    license="Apache 2.0",
    description=("Flexible Spatial-Temporal Multiplexing for LLM Serving"),
    ...
    packages=setuptools.find_packages(exclude=("benchmark", "csrc", "docs",
                                               "examples", "tests")),
    python_requires=">=3.8",
